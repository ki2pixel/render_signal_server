...
-   [2025-12-21 14:36] **Standardisation des environnements virtuels**
    - Mise à jour de la documentation pour privilégier l'utilisation d'un environnement virtuel partagé dans `/mnt/venv_ext4/venv_render_signal_server`
    - Mise à jour des fichiers de documentation (`README.md`, `docs/installation.md`, `docs/testing.md`, `docs/deploiement.md`)
    - Maintien d'une option alternative avec un environnement virtuel local (`.venv`)
