...
## Pré-requis
- Connaissance des règles dans `.continue/rules/codingstandards.md` (pas d'`innerHTML`, accessibilité, autosave debounce).
...
## Ressources
- `./.windsurf/skills/webhook-dashboard-ux-maintainer/test_dashboard_ux.sh` : checklist manuelle + exécution des tests backend associés.
