...
- **Authorized Tools**: `task-master-ai`, `sequentialthinking_tools`, `edit_file`, `fast_read_multiple_files`, `json_query_jsonpath`, `json_query_search_keys`, `render-signal-mcp`, `redis-signal-mcp-server`.
