...
## Ressources
- `.windsurf/skills/routing-rules-orchestrator/test_routing_rules.sh` : active le venv, exécute les suites service, API, orchestrator et les scénarios stop_processing.
