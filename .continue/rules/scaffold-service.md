...
## Template
Utilise le fichier `.windsurf/skills/scaffold-service/service_template.py` comme base. Remplace `NewService` par le nom du service demandé (PascalCase) et adapte les docstrings.