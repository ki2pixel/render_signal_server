...
# --- Helpers: Provider link extraction (Dropbox, FromSmash, SwissTransfer) ---
...
# Note: Nous ne tentons plus de résoudre des liens "directs" (ZIP/API). Les URLs détectées sont
# renvoyées telles quelles (landing pages) et l'UI propose un bouton pour ouvrir la page.

# Headless/Playwright direct-link resolution supprimé: simplification et stabilité accrue.
