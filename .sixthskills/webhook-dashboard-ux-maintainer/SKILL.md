...
## Pré-requis
- Connaissance des règles dans `.sixthrules/01-codingstandards.md` (pas d'`innerHTML`, accessibilité, autosave debounce).
...
5. **Tests manuels**
   - Lancer le helper `./.sixthskills/webhook-dashboard-ux-maintainer/test_dashboard_ux.sh`.
