...
- Le helper `./.sixthskills/run-tests/run_tests.sh` est un simple wrapper vers la commande ci-dessus, conservé pour compatibilité. Utilise-le seulement si l'appel direct n'est pas disponible.